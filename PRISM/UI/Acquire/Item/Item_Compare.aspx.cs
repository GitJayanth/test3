...
namespace HyperCatalog.UI.ItemManagement
{
    ...
    /// </summary>
    public partial class item_Compare : HCPage
    {
        ...
        private DataSet Compare()
        {
            using (Database dbObj = Utils.GetMainDB())
            {
                ...
                if (!staticMode)
                {
                    ...
                    new SqlParameter("@ContainerTypeCode", ContainerTypeCode));
                }
                else
                {
       ...
       //private void CompareWrtContainerTypes()
       // {
       ...
       //     //UpdateDataView(ds);
       //     //return ds; 
       //     Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "CompareWrtContainerTypes()", "<script>CompareWrtContainerTypes('" + itemId + "', '" + cultureCode + "','" + preference + "','" + ContainerTypeCode + "');</script>");
       // }
