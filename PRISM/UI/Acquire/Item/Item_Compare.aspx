...
<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.Empty.master" Inherits="HyperCatalog.UI.ItemManagement.item_Compare" CodeFile="item_Compare.aspx.cs" %>
...
<asp:Content ID="Javascript" ContentPlaceHolderID="HOJS" runat="server">
    <script type="text/javascript">
      ...
      oEvent.cancelPostBack = true;
		...
		function CompareWrtContainerTypes(i,l,preference,ContainerTypeCode){
		    top.resizeTo(800,500);
		    window.location = "item_comparison.aspx?m=&c=" + l + "&i=" + i + "&preference=" + preference + "&ContainerTypeCode=" + ContainerTypeCode
		  }
