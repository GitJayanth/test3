...
#endregion
	/// <summary>
	/// Description résumée de Chunk_Localizations.
	/// </summary>
public partial class Chunk_Localizations : HCPage
{
  ...
  {
    dg.DataSource = HyperCatalog.Business.Chunk.GetTranslations(itemId, containerId, cultureCode);
