...
{
  /// <summary>
  /// Description résumée de Chunk_Resource.
  /// </summary>
  public partial class Chunk_Resource : HCPage
  {
    #region Declarations
    ...
    private void UpdateDataView()
    {
      try
      {
        ...
        if (Request["l"] != null)
        {
          txtCulture.Value = Request["l"].ToString();
        }
        else
        {
          txtCulture.Value = chunk.CultureCode;
        }
      }
      catch
      {
      ...
      if (chunk != null)
      {
        if (chunk.Text == HyperCatalog.Business.Chunk.BlankValue)
        {
          ...
          txtValue.Enabled = false;
          txtImagePath.Value = txtValue.Text = HyperCatalog.Business.Chunk.BlankText;
        }
        else
        {
          txtImagePath.Value = txtValue.Text = chunk.Text;
        }
      ...
      else
      {
        ...
        txtImagePath.Value = txtValue.Text = string.Empty;
