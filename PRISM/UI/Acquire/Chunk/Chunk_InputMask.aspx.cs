...
{
  /// <summary>
  /// Description résumée de Chunk_InputMask.
  /// </summary>
  public partial class Chunk_InputMask : HCPage
  {
    #region Declarations
    ...
    private void UpdateDataView()
    {
      ...
      txtValue.InputMask = container.InputMask;
      if (chunk != null)
      {
        if (chunk.Text == HyperCatalog.Business.Chunk.BlankValue)
        {
          ...
          Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "isBlankChunk", "<script>isBlankChunk = true;</script>"); // ACQ10.0
          txtValue.Text = null;
        ...
        else
        {
          ...
          Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "isBlankChunk", "<script>isBlankChunk = false;</script>");// ACQ10.0
        }
      ...
      {
        txtValue.Value = null;
        //txtValue.Enabled = false; //ACQ10.0
