...
<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.Empty.master" Inherits="Chunk_Regionalizations" CodeFile="chunk_regionalizations.aspx.cs" %>
          ...
          <td>
            <igtbl:ultrawebgrid id="dg" runat="server" Width="100%"  ImageDirectory="/ig_common/Images/">
              <DisplayLayout StationaryMargins="Header" AutoGenerateColumns="False" RowHeightDefault="100%" Version="4.00"
                ...
                <%--Removed the cssclass and added inline property by Radha to fix infragestic issue--%>
