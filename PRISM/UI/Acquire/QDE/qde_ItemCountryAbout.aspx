<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.Empty.master" Inherits="HyperCatalog.UI.Acquire.QDE.QDE_ItemCountryAbout" CodeFile="qde_ItemCountryAbout.aspx.cs"%>
...
<asp:Content ID="Main" ContentPlaceHolderID="HOCP" runat="server">
	<script type="text/javascript" language="javascript">
	  document.body.onunload = "closeWindows";
		...
		<igmisc:webpanel id="wPanelIdentity" runat="server" CssClass="hc_webpanel" ImageDirectory="/hc_v4/img/" ExpandEffect="None">
					...
					<table cellspacing="0" cellpadding="0" width="100%" border="0">
					    ...
					    <asp:panel id="PanelMasterName" Runat="server">
						    <td style="width: 90px; height: 18px">
						      <b><asp:label id="lbMasterNameLabel" runat="server">Original</asp:label></b>
						    </td>
						  ...
						  <td>
							  <igtbl:ultrawebgrid id="dg" runat="server">
								  <DisplayLayout AutoGenerateColumns="False" AllowSortingDefault="Yes" Version="4.00" HeaderClickActionDefault="SortSingle"
									  ...
									  <FrameStyle CssClass="dataTable"></FrameStyle>
