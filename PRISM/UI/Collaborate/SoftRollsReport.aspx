<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.master" AutoEventWireup="true"
  CodeFile="SoftRollsReport.aspx.cs" Inherits="UI_Globalize_SoftRollsReport" %>
          ...
          <Bands>
            <igtbl:UltraGridBand>
              <Columns>
                ...
                <igtbl:UltraGridColumn BaseColumnName="PLCode" HeaderText="PL" Key="PL" Width="60px">
                  <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                  <CellStyle HorizontalAlign="Center">
                  </CellStyle>
                </igtbl:UltraGridColumn>
                <igtbl:UltraGridColumn BaseColumnName="Class" Key="Class" Width="150px">
                
                </igtbl:UltraGridColumn>
                <igtbl:UltraGridColumn BaseColumnName="Name" HeaderText="Name" Key="Name" Width="100%">
                </igtbl:UltraGridColumn>
                <igtbl:UltraGridColumn BaseColumnName="ReplacementDate" HeaderText="Replacement date" Key="ReplacementDate" Width="150px">
                </igtbl:UltraGridColumn>
		<igtbl:UltraGridColumn BaseColumnName="Comment" HeaderText="Comment" Key="Comment" Width="250px"> 
		</igtbl:UltraGridColumn>
