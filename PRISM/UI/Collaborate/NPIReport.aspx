<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.master" AutoEventWireup="true" CodeFile="NPIReport.aspx.cs" Inherits="UI_Collaborate_NPIReport" %>
        ...
        <igtbar:UltraWebToolbar ID="uwToolbar" runat="server" ItemWidthDefault="80px"
         ...
         <ClientSideEvents InitializeToolbar="uwToolbar_InitializeToolbar" Click="uwToolbar_Click"></ClientSideEvents>
          ...
          <igtbar:TBCustom ID="TBCustom2" runat="server" Width="160px">
              <asp:DropDownList ID="DDL_Countries" runat="server" AutoPostBack="True" Width="150px"
                OnSelectedIndexChanged="DDL_Countries_SelectedIndexChanged">
              </asp:DropDownList>
            </igtbar:TBCustom>
          ...
          <Bands>
            <igtbl:UltraGridBand>
              <Columns>
                ...
                <igtbl:UltraGridColumn BaseColumnName="ProductName" HeaderText="Product Name" Key="Name" Width="300px">
                </igtbl:UltraGridColumn>
                <igtbl:UltraGridColumn BaseColumnName="ItemId" Key="ItemId" Hidden="true" >
                </igtbl:UltraGridColumn>
                <igtbl:UltraGridColumn BaseColumnName="ModifyDate" Key="ModifyDate" HeaderText="NPI Date">
