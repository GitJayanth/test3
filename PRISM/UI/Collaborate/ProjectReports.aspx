<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.master" AutoEventWireup="true" CodeFile="ProjectReports.aspx.cs" Inherits="UI_Globalize_ProjectReports" %>
...
<asp:Content ID="PageTitle" ContentPlaceHolderID="HOPT" runat="server">Project reports</asp:Content>
			...
			<tr valign="top">
				<td>
					<igtab:ultrawebtab id="webTab" runat="server" DummyTargetUrl="/hc_v4/pleasewait.htm" BorderStyle="Solid"
						...
						<Tabs>
							<igtab:Tab Text="Beginning of Regionalization (BOR)" Key="EOM">
								<ContentPane TargetUrl="./ProjectReports/ProjectReport.aspx?r=1" Visible="False"></ContentPane>
							</igtab:Tab>
							<igtab:Tab Text="End of Regionalization (EOR)" Key="EOV">
								<ContentPane TargetUrl="./ProjectReports/ProjectReport.aspx?r=2" Visible="False"></ContentPane>
							</igtab:Tab>
						</Tabs>
					</igtab:UltraWebTab>
                    </td>
