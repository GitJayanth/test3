<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.Empty.master" Inherits="datatype_containers" CodeFile="datatype_containers.aspx.cs" %>
					...
					<td>
						<igtbl:ultrawebgrid id="dg" runat="server" Width="100%">
							<DisplayLayout MergeStyles="False" AutoGenerateColumns="False" AllowSortingDefault="OnClient" SelectTypeRowDefault="Single"
                                ...
                                <%-- Fix for QC# 7384 and QC#7386 by Radha - added border details in FrameStyle,RowStyleDefault and RowAlternateStyleDefault--%>
								...
								<FrameStyle Width="100%" CssClass="dataTable">
                                    <BorderDetails StyleBottom ="Solid" StyleRight ="Solid" WidthRight ="1pt" WidthLeft ="1pt" />
                                </FrameStyle>
