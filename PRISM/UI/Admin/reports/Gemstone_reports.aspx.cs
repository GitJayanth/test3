...
using HyperCatalog.WebServices.DAMWS;




public partial class Gemstone_reports : System.Web.UI.Page
{
    String FileD = "";
    ...
    protected void submit1_Click(object sender, EventArgs e)
    {
        ...
        //New code start
        byte[] fileBytes = null;
        DAMWebService damws = HyperCatalog.WebServices.WSInterface.DAM;
        try
        {
        fileBytes = damws.ResourceBinaryGetByPath("Reports/Delivery.xls");


        //    Page.ClientScript.RegisterClientScriptBlock(typeof(Page), "ClientScript", "alert('The report is not yet generated');", true);
            ...
            Response.Flush();
            //Response.OutputStream.Write(xmlbyt, 0,buffer.Length);
            Response.End();
            Response.Clear();
        }
        catch(Exception ex)
        {
            String ErrorMsg = "No Records to be exported";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ds3.Tables[0].Rows.Count > 0)
            {
                ...
                //FIX for QC 1188 -- DateTime conversion added.
                sb.Append("Date" + " : " + Convert.ToDateTime(DCDate.CalendarLayout.SelectedDate).ToString("MM/dd/yyyy") + "<br>");
                //FIX for QC 1188 -- DateTime conversion added
