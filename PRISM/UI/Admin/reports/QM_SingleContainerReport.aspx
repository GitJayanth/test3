<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.master" AutoEventWireup="true" CodeFile="QM_SingleContainerReport.aspx.cs" Inherits="QM_SingleContainerReport" %>
<asp:Content ID="PageTitle" ContentPlaceHolderID="HOPT" Runat="Server">
Quality Monitor Report [Single-Container]
</asp:Content>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <script>
    function UltraWebGrid1_InitializeLayout(gridName){
     var ColumnOneHeader = igtbl_getElementById("ContainerId");
     var ColumnTwoHeader = igtbl_getElementById("ContainerName");
         ColumnOneHeader.colSpan=2;
                     ColumnTwoHeader.style.display = "none";
    }
</script>

        <asp:Label ID="Label1" runat="server" Text="Label" Width="379px"></asp:Label><br />
        &nbsp;
