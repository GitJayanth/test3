...
/// <summary>
/// Display list of containers belonging to the selected group
///		--> Return to the list of container group
///		--> Export in Excel
///		--> Filter on all fields of the grid
/// </summary>
public partial class containergroup_containers : HCPage
{
  #region Declarations

  private string containerGroupId = string.Empty;
  #endregion
  ...
  protected void Page_Load(object sender, System.EventArgs e)
  {
    ...
    if (Request["d"] != null)
      containerGroupId = Request["d"].ToString();

    if ((!Page.IsPostBack) && (containerGroupId.Length > 0))
      UpdateDataView();
  }
  ...
  private void uwToolbar_ButtonClicked(object sender, Infragistics.WebUI.UltraWebToolbar.ButtonEvent be)
  {
    ...
    if (btn == "export")
    {
      Utils.ExportToExcel(dg, containerGroupId + "-Containers", containerGroupId + "-Containers");
    }
  }
}
