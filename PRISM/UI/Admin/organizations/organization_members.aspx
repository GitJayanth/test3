<%@ Page Language="C#" MasterPageFile="~/HyperCatalog.Empty.master" Inherits="organization_members" CodeFile="organization_Members.aspx.cs" %>
...
<%--Removed width tag from ultrawebtoolbar to fix moving icon issue by Radha S--%>
					...
					<td>
						<igtbl:ultrawebgrid id="dg" runat="server" Width="100%">
							<DisplayLayout MergeStyles="False" AutoGenerateColumns="False" AllowSortingDefault="OnClient" SelectTypeRowDefault="Single"
                                ...
                                <%--Removed the css class and added inline property and border details by Radha S--%>
							...
							<Bands>
								<igtbl:UltraGridBand BaseTableName="Users" Key="Users" BorderCollapse="Collapse" DataKeyField="UserId">
									<Columns>
										...
										<igtbl:UltraGridColumn HeaderText="Role" Key="RoleName" Width="100%" BaseColumnName="RoleName" CellMultiline="Yes">
											<CellStyle Wrap="True"></CellStyle>
											<Footer Key="RoleName"></Footer>
											<Header Key="RoleName" Caption="Role"></Header>
